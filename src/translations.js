const translations = {
  ...
  'es': {
    ...
    volComm: { forum: '💬 Foro de Voluntarios', training: '🎓 Rutas de Entrenamiento' },
    ...
    ongContent: { stats: 'Estadísticas', activeJobs: 'Ofertas Activas', totalVols: 'Voluntarios', hours: 'Horas Donadas', impact: 'Impacto Estimado', manageRoles: 'Ofertas en Curso', addRole: 'Nueva Oferta', manageVols: 'Nuestros Voluntarios', searchVol: 'Buscar voluntario...', reportsAndCerts: 'Informes y Certificados' },
